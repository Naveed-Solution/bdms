...
const AdminProfile: React.FC = () => {
  ...
  const handleSendEmailCode = async () => {
    ...
    try {
      ...
      const response = await fetch('http://192.168.0.120:3000/api/send-verification', {
        method: 'POST',
  ...
  const handleUpdateEmail = async () => {
    ...
    try {
      ...
      // Verify code
      const verifyResponse = await fetch('http://192.168.0.120:3000/api/verify-code', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          email: newEmail,
      ...
      // Update email
      const updateResponse = await fetch(`http://192.168.0.120:3000/api/admin/update-email`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userId: user?.id,
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      // Change password
      const updateResponse = await fetch('http://192.168.0.120:3000/api/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          email: user?.email,
