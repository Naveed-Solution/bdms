...
const AdminProfile: React.FC = () => {
  ...
  const handleSendEmailCode = async () => {
    ...
    try {
      ...
      const response = await fetch('http://https://192.168.1.26/api/send-verification', {
        method: 'POST',
  ...
  const handleUpdateEmail = async () => {
    ...
    try {
      ...
      // Verify code
      const verifyResponse = await fetch('http://https://192.168.1.26/api/verify-code', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          email: newEmail,
      ...
      // Update email
      const updateResponse = await fetch(`http://https://192.168.1.26/api/admin/update-email`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          userId: user?.id,
  ...
  const handleChangePassword = async () => {
    ...
    try {
      ...
      // Change password
      const updateResponse = await fetch('http://https://192.168.1.26/api/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          email: user?.email,
