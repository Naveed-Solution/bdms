...
const UserProfileDetail: React.FC = () => {
  ...
  const loadUserDetails = async () => {
    try {
      ...
      const response = await fetch(`https://bdms-production.up.railway.app/api/admin/user/${userId}/details`);
  ...
  const handleDeactivate = async () => {
    ...
    try {
      const response = await fetch(
        `https://bdms-production.up.railway.app/api/admin/users/${userId}/deactivate`,
        {
          method: 'POST',
  ...
  const handleActivate = async () => {
    ...
    try {
      const response = await fetch(
        `https://bdms-production.up.railway.app/api/admin/users/${userId}/activate`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        }
