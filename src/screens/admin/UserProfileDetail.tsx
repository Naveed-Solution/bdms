...
const UserProfileDetail: React.FC = () => {
  ...
  const loadUserDetails = async () => {
    try {
      ...
      const response = await fetch(`http://192.168.0.120:3000/api/admin/user/${userId}/details`);
  ...
  const handleDeactivate = async () => {
    ...
    try {
      const response = await fetch(
        `http://192.168.0.120:3000/api/admin/users/${userId}/deactivate`,
        {
          method: 'POST',
  ...
  const handleActivate = async () => {
    ...
    try {
      const response = await fetch(
        `http://192.168.0.120:3000/api/admin/users/${userId}/activate`,
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
        }
